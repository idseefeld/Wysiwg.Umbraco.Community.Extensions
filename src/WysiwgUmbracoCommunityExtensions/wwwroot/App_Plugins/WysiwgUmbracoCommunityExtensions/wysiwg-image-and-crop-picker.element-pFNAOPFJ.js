...
import { html as _, nothing as P, repeat as ne, css as B, property as h, state as u, customElement as U } from "@umbraco-cms/backoffice/external/lit";
...
import { W as q } from "./services.gen-ya8kz8Ij.js";
...
var fe = Object.defineProperty, ge = Object.getOwnPropertyDescriptor, D = (e) => {
  throw TypeError(e);
}, p = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? ge(t, i) : t, r = e.length - 1, o; r >= 0; r--)
    (o = e[r]) && (a = (s ? o(t, i, a) : o(a)) || a);
  return s && a && fe(t, i, a), a;
}, k = (e, t, i) => t.has(e) || D("Cannot " + i), y = (e, t, i) => (k(e, t, "read from private field"), i ? i.call(e) : t.get(e)), w = (e, t, i) => t.has(e) ? D("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), O = (e, t, i, s) => (k(e, t, "write to private field"), t.set(e, i), i), m = (e, t, i) => (k(e, t, "access private method"), i), b, E, I, M, c, S, A, x, K, L, V, F, Y, G, X, H, Z, J;
...
let n = class extends N(R, void 0) {
  constructor() {
    super(), w(this, c), w(this, b, new ye(this, {
    ...
    })), this.min = 0, this.minMessage = "This field need more items", this.max = 1 / 0, this.maxMessage = "This field exceeds the allowed amount of items", this.multiple = !1, w(this, E, !1), w(this, I, !1), this._cards = [], w(this, M, new ue(this, se)), w(this, A, (e) => this.allowedContentTypeIds && this.allowedContentTypeIds.length > 0 ? this.allowedContentTypeIds.includes(e.mediaType.unique) : !0), this.observe(y(this, M).items, () => {
      m(this, c, S).call(this);
    }), new me(this, ae).addAdditionalPath(":key").onSetup((e) => {
      var s;
      const t = e.key;
      if (!t) return !1;
      ...
      this.value = (t = this.value) == null ? void 0 : t.map((i) => {
        ...
        const s = this.focalPointEnabled ? e.focalPoint : null, a = e.crops, r = e.unique, o = r === i.mediaKey ? i.key : W.new();
  ...
  set value(e) {
    super.value = e, y(this, b).setModel(e), y(this, M).setUniques(e == null ? void 0 : e.map((t) => t.mediaKey)), m(this, c, S).call(this);
  }
  get value() {
    return super.value;
  }
  ...
  render() {
    return _`
    ${m(this, c, F).call(this)}
    <div class="container">${m(this, c, Y).call(this)} ${m(this, c, G).call(this)}</div>
  `;
  }
  _updateValue(e, t = !1) {
    const i = [];
    ...
    this.value = i, this.dispatchEvent(new $());
  }
};
...
x = function(e) {
  ...
  this.value = [...this.value ?? [], ...t], this.dispatchEvent(new $());
};
K = async function() {
  const e = await this.getContext(de), t = e == null ? void 0 : e.open(this, re, {
    data: {
...
L = async function(e) {
  ...
  }), this.value = (t = this.value) == null ? void 0 : t.filter((i) => i.key !== e.unique), this.dispatchEvent(new $());
};
V = async function(e) {
...
X = function(e) {
  ...
  return _`
    <wysiwg-card-image id=${e.unique} name=${e.name} .href=${i} ?readonly=${this.readonly}>
      ...
      <wysiwg-cropped-image .mediaItem=${t} @change=${m(this, c, H)}></wysiwg-cropped-image>
      ${m(this, c, J).call(this, e)} ${m(this, c, Z).call(this, e)}
...
var we = Object.defineProperty, Ce = Object.getOwnPropertyDescriptor, Q = (e) => {
  throw TypeError(e);
}, d = (e, t, i, s) => {
  for (var a = s > 1 ? void 0 : s ? Ce(t, i) : t, r = e.length - 1, o; r >= 0; r--)
    (o = e[r]) && (a = (s ? o(t, i, a) : o(a)) || a);
  return s && a && we(t, i, a), a;
}, be = (e, t, i) => t.has(e) || Q("Cannot " + i), Ie = (e, t, i) => t.has(e) ? Q("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), T = (e, t, i) => (be(e, t, "access private method"), i), C, j, ee, te, ie;
const $e = "wysiwg-image-and-crop-picker";
let l = class extends N(R) {
  //#endregion
  constructor() {
    super(), Ie(this, C), this.mandatoryMessage = z, this.readonly = !1, this._focalPointEnabled = !1, this._preselectedCrops = [], this._allowedMediaTypes = [], this._multiple = !1, this._min = 0, this._max = 1 / 0, this._selectedCropAlias = "", this._options = [], this._mediaTypes = [], this._imgSrc = "", this._prevImgSrc = "", this.consumeContext(le, (e) => {
      this.observe(
  ...
  set config(e) {
    ...
    this._startNode = t ? { unique: t, entityType: oe } : void 0;
  ...
  _updateValue(e, t = !1) {
    ...
    this.value = i, this.dispatchEvent(new he());
  }
  render() {
    return _`
    <div id="container">
...
//# sourceMappingURL=wysiwg-image-and-crop-picker.element-pFNAOPFJ.js.map
