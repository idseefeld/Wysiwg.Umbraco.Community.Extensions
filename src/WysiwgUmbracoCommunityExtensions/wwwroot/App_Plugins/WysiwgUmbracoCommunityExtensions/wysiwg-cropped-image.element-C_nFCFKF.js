...
}, ve = (e, t, i) => t.has(e) || Z("Cannot " + i), ye = (e, t, i) => t.has(e) ? Z("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), R = (e, t, i) => (ve(e, t, "access private method"), i), E, V, ee;
const h = {
...
let u = class extends pe {
  ...
  async prozessSettings(e) {
    ...
    if ((i = e.settingsData) != null && i.length) {
      ...
      ), g = (o = e == null ? void 0 : e.settingsData) == null ? void 0 : o.find(
        (c) => c.key === (y == null ? void 0 : y.settingsKey)
      ), d = (g == null ? void 0 : g.values) ?? [];
      ...
      await R(this, E, V).call(this, ce).then((c) => {
  ...
  setBackgroudStyle(e) {
    ...
    if (e != null && e.length) {
      ...
      t.minHeight = y;
      let g = (r = e == null ? void 0 : e.find((d) => d.alias === "padding")) == null ? void 0 : r.value.toString();
      g || (g = a && !_ ? "10px" : ""), t.padding = g;
    }
...
const be = u, Je = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
...
let m = class extends Q {
  ...
  async requestCropUrl(e) {
    ...
    if (!((y = this.mediaItem) != null && y.mediaKey))
      return;
    const t = ((g = this.mediaItem.selectedCropAlias) == null ? void 0 : g.toLowerCase()) ?? "", i = (d = this.mediaItem.crops) == null ? void 0 : d.find((C) => C.alias === t), o = i ? JSON.stringify(i) : "", r = this.mediaItem.focalPoint ? JSON.stringify(this.mediaItem.focalPoint) : "", n = {
      query: {
