...
import { i as oe, j as ne } from "./sdk.gen-DlhRCxT4.js";
...
}, T = (e, t, i) => t.has(e) || R("Cannot " + i), m = (e, t, i) => (T(e, t, "read from private field"), i ? i.call(e) : t.get(e)), f = (e, t, i) => t.has(e) ? R("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, i), x = (e, t, i, s) => (T(e, t, "write to private field"), t.set(e, i), i), u = (e, t, i) => (T(e, t, "access private method"), i), w, M, C, b, h, A, I, P, V, N, z, D, K, L, W, F, Y, G;
const _e = "wysiwg-input-rich-media";
let o = class extends O(q, void 0) {
  constructor() {
  ...
  render() {
    ...
    <div class="container">${u(this, h, K).call(this)} ${u(this, h, L).call(this)}</div>
  `;
  }
  _updateValue(e, t = !1) {
    const i = [];
...
d([
  l({ type: Array })
], o.prototype, "allowedContentTypeIds", 2);
d([
...
d([
  l({ type: Array })
], o.prototype, "preselectedCrops", 2);
d([
  l({ type: Boolean })
], o.prototype, "focalPointEnabled", 1);
d([
  l()
], o.prototype, "alias", 1);
d([
...
d([
  c()
], o.prototype, "_cards", 2);
d([
  c()
], o.prototype, "_routeBuilder", 2);
o = d([
  S(_e)
], o);
...
p([
  c()
], n.prototype, "_startNode", 2);
p([
  c()
], n.prototype, "_focalPointEnabled", 2);
p([
  c()
], n.prototype, "_preselectedCrops", 2);
p([
  c()
...
p([
  c()
], n.prototype, "_selectedCropAlias", 2);
p([
  c()
], n.prototype, "_options", 2);
p([
  c()
], n.prototype, "_mediaTypes", 2);
p([
  c()
], n.prototype, "_imgSrc", 2);
p([
  c()
], n.prototype, "_prevImgSrc", 2);
n = p([
  S(Ce)
], n);
export {
  n as WysiwgImageAndCropPickerElement,
  n as element
};
//# sourceMappingURL=wysiwg-image-and-crop-picker.element-DDKkKiBf.js.map
