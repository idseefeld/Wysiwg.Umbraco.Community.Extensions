...
export const PagedWebhookLogResponseModelSchema = {
    required: ['items', 'total'],
    type: 'object',
    properties: {
        total: {
...
export const WebhookLogResponseModelSchema = {
    required: ['date', 'eventAlias', 'exceptionOccured', 'isSuccessStatusCode', 'key', 'requestBody', 'requestHeaders', 'responseBody', 'responseHeaders', 'retryCount', 'statusCode', 'url', 'webhookKey'],
    type: 'object',
    properties: {
        key: {
            type: 'string',
