...
import WysiwgImageCropperElement from './wysiwg-image-cropper.element';

const elementName = 'wysiwg-image-cropper-field';

@customElement(elementName)
export class WysiwgInputImageCropperFieldElement extends UmbLitElement {
	...
	#onCropChange = (event: UmbImageCropChangeEvent) => {
		const target = event.target as WysiwgImageCropperElement;
...
declare global {
	interface HTMLElementTagNameMap {
		[elementName]: WysiwgInputImageCropperFieldElement;
	}
}
