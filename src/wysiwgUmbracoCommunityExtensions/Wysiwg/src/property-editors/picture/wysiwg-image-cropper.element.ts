import { UmbImageCropChangeEvent, type UmbImageCropperCrop, type UmbImageCropperFocalPoint } from '@umbraco-cms/backoffice/media';
...
const elementName = 'wysiwg-image-cropper';

@customElement(elementName)
export class WysiwgImageCropperElement extends UmbLitElement {
...
export default WysiwgImageCropperElement;

declare global {
	interface HTMLElementTagNameMap {
		[elementName]: WysiwgImageCropperElement;
	}
}
